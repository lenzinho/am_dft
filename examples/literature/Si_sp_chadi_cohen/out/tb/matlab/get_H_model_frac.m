...
H = [[      v(1),         0,         0,         0, g(4)*v(3), g(3)*v(4), g(1)*v(4),-g(2)*v(4)];
     [         0,      v(2),         0,         0,-g(3)*v(4), g(4)*v(6), g(2)*v(5),-g(1)*v(5)];
     [         0,         0,      v(2),         0,-g(1)*v(4), g(2)*v(5), g(4)*v(6),-g(3)*v(5)];
     [         0,         0,         0,      v(2), g(2)*v(4),-g(1)*v(5),-g(3)*v(5), g(4)*v(6)];
     [ g(8)*v(3),-g(7)*v(4),-g(5)*v(4), g(6)*v(4),      v(1),         0,         0,         0];
     [ g(7)*v(4), g(8)*v(6), g(6)*v(5),-g(5)*v(5),         0,      v(2),         0,         0];
     [ g(5)*v(4), g(6)*v(5), g(8)*v(6),-g(7)*v(5),         0,         0,      v(2),         0];
     [-g(6)*v(4),-g(5)*v(5),-g(7)*v(5), g(8)*v(6),         0,         0,         0,      v(2)]];
