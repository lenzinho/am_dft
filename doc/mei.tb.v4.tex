...
\title{Electronically-induced Phonon Softening in Transition-Metal Nitrides}
...
\section{Main}
Topological electronic properties of B1 NaCl-structure VN are investigated using a minimal-basis orthogonal second-neighbor tight-binding model based upon V $d$ and N $p$ orbitals. 
...
% ---------------------------------------------------------------------------------
% ---------------------------------------------------------------------------------
% NOTES ON TIGHT BINDING PARAMETERS
%
%hilbert space ( remember that for the paper, 6 and 7 are interchanged )
%
%d_eg has two states (higher in energy) ;  d_t2g has three states (lower in energy)
%        
%   Γ               [001]  [010]  [100]  [011]  [110] <-- k point used to evaluate hamiltonian 
%1  p       x         x                                  
%2  p       y         y                                  
%3  p       z         z                                  
%4  d t2g   xz       ...     y     ...    ...    ...       
...
%
%eg      dx2-y2 dz2 imposible to distinguish between both states
%t2g     dxz dyz dxy 
%
%p_{x}, p_{y}, p_{z}, d_{xz}, d_{xy},  d_{x^2-y^2}, d_{yz}, d_{z^2} %%  MATLAB ORDER
%
%             p_{x},    p_{y},       p_{z}
%d_{xz}      [  c11,        0,           0]
%d_{xy}      [    0,        0,           0]
%d_{x^2-y^2} [    0,        0,         c12]
%d_{yz}      [    0,     -c11,           0]
%d_{z^2}     [    0,        0, 3^(1/2)*c12]
%
%               d_{xz}, d_{xy},     d_{x^2-y^2},       d_{yz},          d_{z^2}
%d_{xz}       [    d12,    d11,               0,            0,               0]
%d_{xy}       [    d11,    d12,               0,            0,               0]
%d_{x^2-y^2}  [      0,      0,       d14 + d16,          d15, (3^(1/2)*d14)/2]
%d_{yz}       [      0,      0,             d15,          d13,    -3^(1/2)*d15]
%d_{z^2}      [      0,      0, (3^(1/2)*d14)/2, -3^(1/2)*d15,             d16]     
% 
%
%      x    y     z
%x  [ e11,   0,   0]
