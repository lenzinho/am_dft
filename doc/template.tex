...
\end{equation}
%
in which $\hbar$ is Planck's reduced constant and $\hat{L}$ is the angular momentum operator. Improper rotations are obtained by premultiplying the scalar inversion operator $(-1)^l$. \cite{sharma_general_1979,el-batanouny_symmetry_2008} % WOOOTEN p 604 after Eq. 14.164
